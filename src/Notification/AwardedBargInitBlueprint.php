...
class AwardedBargInitBlueprint implements BlueprintInterface, MailableInterface
{
    ...
    {
        return 'awardedBargInit'; //forum/index.js
    }
    ...
    {
        return ['text' => 'alterbyte-barg-init::emails.awardedBargInit'];
    }
    ...
    {
        return $translator->trans('barg-init.forum.notification.awarded_email', [ //change
